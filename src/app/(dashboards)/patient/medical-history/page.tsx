...
export default function MedicalHistoryPage() {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const docsRes = await fetch("/api/patient/documents");
        ...
        <DashboardLayout>
            <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h2 className="text-4xl font-black text-slate-900 tracking-tight">Uploads & Records</h2>
                        <p className="text-slate-500 font-medium mt-2">Manage your personal medical records and uploaded documents.</p>
                    </div>
