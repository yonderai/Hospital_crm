                                    ...
                                    <tr key={idx} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-2">
                                                <span className={`text-[10px] font-black ${p.status === 'Active' ? 'text-green-600' : 'text-slate-400'}`}>
                                                    {p.lastVisit}
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <p className="text-[10px] font-black uppercase text-slate-500 tracking-tight">{p.status}</p>
                                            </div>
                                        </td>
